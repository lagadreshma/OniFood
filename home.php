...
if(isset($_POST['add-to-cart'])){
 ...
 if(isset($_SESSION['cart'])){
    ...
    $item_array_id = array_column($_SESSION['cart'],"dish_id");

    if(in_array($_POST['dish_id'],$item_array_id)){
      ...
      echo "<script> window.location.href = 'home.php'; </script>";
        ...
        mysqli_query($conn, "insert into cart(user_id,dish_id,dish_name,dish_image,dish_price,dish_quantity) values ('$user_id','$dish_id','$dish_name','$dish_image','$dish_price','$dish_quantity')") or die("insert error");

        $count = count($_SESSION['cart']);
        $item_array = array('dish_id' => $_POST['dish_id']);
      ...
      <form action="" method="post">
        ...
        <div class="card shadow">
           ...
           <div class="card-body">
             ...
             <input type="hidden" name="dish_image" value="<?php echo $result['dish_image']; ?>">
             <input type="hidden" name="dish_name" value="<?php echo $result['dish_name']; ?>">
             <input type="hidden" name="dish_price" value="<?php echo $result['price']; ?>">
