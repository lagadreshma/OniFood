...
if(isset($_POST['cancel'])){
  ...
  $update_order = "update orders set order_status='cancel' where order_id={$order_id}";
  ...
  if($result){
     ...
     echo "<script> windows.location.href='view_order.php'; </script>";
    ...
    <section class="header home">
      ...
      <nav>
        ...
        <div class="navbar" id="navlinks">
          ...
          <section class="view_orders_section">
            ...
            <div class="view_orders">
              ...
              <?php
                ...
                username='$username'")or die(" order query failed.");
                ...
                <div class="user_details">
                  ...
                  <h1> User <span> Delivery Details </span> </h1>

                  <div class="two-col">
                    <div>
                      <label for="name">Username</label> <br>
                      <input type="text" name="name" value="<?php echo
                        $result['username'];?>" autocomplete="off"
                ...
                <div class="myorder_details">
                  ...
                  <h1> My <span> Order Details </span> </h1>

                  <div class="two-col">
                    <h3>
                      Order Id - <input type="text" value="<?php echo $result['order_id']; ?>">
                    </h3>
                    <h3>
                      Order Status - <input type="text" class="status" value="<?php echo $result['order_status']; ?>">
                    </h3>
                  </div>
                  <div class="two-col">
                    <h3>
                     Products - <input type="text" value="<?php echo $result['total_products']; ?>">
                    </h3>
                    <h3>
                      Total Price <span>&#x20B9</span> - <input type="text" value="<?php echo $result['total_price']; ?>">
                    </h3>
                  </div>
                  <div class="two-col">
                    <h3>
                      Payment Mode - <input type="text" value="<?php echo $result['payment_mode']; ?>">
                    </h3>
                    <h3>
                      Payment Status - <input type="text" value="<?php echo $result['payment_status']; ?>">
                    </h3>
                  </div>
                  <div class="two-col">
                    <h3>
                      Order Placed At - <input type="text" value="<?php echo $result['order_placed']; ?>">
                    </h3>
                  </div>
                  <div class="two-col">
                    <h3>
                      <form action="" method="post">
                        ...
                        <input type="submit" name="cancel" class="cancel" value="X Cancel Order">
                      </form>
                    </h3>
                  </div>
